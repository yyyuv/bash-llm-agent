...
**Next:** capture Phase 5 **and** Phase 6 live transcripts to close those gates (Phase 6 live cases 32–38 in [tests/cases.md](tests/cases.md)), then **Phases 7–9 remain ⏸-gated** (re-review before starting); Phase 7 is user shell-history awareness.
