...
\textbf{qwen wins (case 57, ``3 most common words'').} qwen composes a correct pipeline and gets the right counts; gemma mis-flags the read-only pipeline as destructive and aborts, answering nothing:
...
\textbf{gemma wins (case 5, ``how do I \dots'').} The tool-calling model is not always the smarter one: gemma correctly explains and runs nothing, while qwen wrongly executes instead of answering:
